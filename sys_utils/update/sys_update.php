...
# install app home
$MS_SOURCE_URL="http://localhost/~peter/www/minisys/sys_utils/update";
...
if ((!isset($_POST["submitstart1"]))and(!$MS_AUTOSTART)){
	...
	echo("<input class='inputsubmit red' type='submit' id='submitstart3' name='submitstart3' value='$L_BUTTON_STOP'>");
	echo("</a>");
}
